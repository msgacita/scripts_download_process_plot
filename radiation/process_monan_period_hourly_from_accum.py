...
def main():
    ...
    out_path = Path(args.out_dir) / f"{args.init}_hourly_{args.var.removeprefix('ac')}.nc"
    out_path.parent.mkdir(parents=True, exist_ok=True)
    ds_out.load()  # materialise lazy arrays and release read-side HDF5 file handles
